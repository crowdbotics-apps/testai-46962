"""
Django settings for testai_46962 project.
...
ROOT_URLCONF = 'testai_46962.urls'
...
WSGI_APPLICATION = 'testai_46962.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testai_46962 API",
    "DESCRIPTION": "API documentation for testai_46962 App",
    "VERSION": "v1",
}
